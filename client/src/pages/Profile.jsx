...
import UserProfileNidEdit from '../components/UserProfileNidEdit';
...
const Profile = () => {
    ...
    const [openProfileNidEdit,setProfileNidEdit] = useState(false)
  ...
  return (
    <div className='p-4'>
        ...
        <button onClick={()=>setProfileNidEdit(true)} className='text-sm min-w-20 border border-primary-100 hover:border-primary-200 hover:bg-primary-200 px-3 py-1 rounded-full mt-3'>Edit</button>
        
        {
            openProfileNidEdit && (
                <UserProfileNidEdit close={()=>setProfileNidEdit(false)}/>
            )
        }
        {/**nid upload and display image */}
